...
?>
  ...
  <!-- Cover -->
  <main>
    <div class="hero" style=" background-image: url('DASH2.png')">
    ...
    <footer class="page-footer">
        ...
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--whybuy">
            ...
            <ul class="footer-nav__list">
              ...
              <li class="footer-nav__item">
                <a href="#" class="footer-nav__link">Best Price</a>
              </li>
              <li class="footer-nav__item">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Kamana Machinery & Tools Center<br>
            Teku Road, Kathmandu, Nepal.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:01-234567">01-234567</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:kamanamachinery@gmail.com" class="email__addr">kamanamachinery@gmail.com</a>
            </div>
          </div>
      ...
      <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-award">
            <span>Best Product</span><br> Best Price
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; 2019 Kamana Machinery&trade;
          </div>
