...
$quantityfromdb=0;
$stockquery="select Quantity from products where product_id=$pro_id";
$runstockquery=mysqli_query($con,$stockquery);
while($row_pro=mysqli_fetch_array($runstockquery)){
    $quantityfromdb=$row_pro['Quantity'];
}
if($quantityfromdb<$product_qty){
echo "<script>alert('Add product Quantity exceeded the Stock Quantity')</script>";
...
<label class="col-md-5 control-label" >Enter Product Quantity </label>

<div class="col-md-7" ><!-- col-md-7 Starts -->
<input type="number" class="form-control" name="product_qty"/>
<!-- <select name="product_qty" class="form-control" input type="text">  >
