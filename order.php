...
while($row_pro=mysqli_fetch_array($runstockquery)){
    ...
    $productupdateqty=$quantityfromdb;
}
$tostock=$productupdateqty-$pro_qty;
$updateqty="update products set Quantity=$tostock where product_id=$pro_id";
$run_updateqty = mysqli_query($con,$updateqty);
